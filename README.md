![Travis Status](https://travis-ci.org/simonjoom/swagger-mongoosev3.svg?branch=master)
# swagger-mongoose-forked from https://github.com/simonguest/swagger-mongoose
REQUIRED validation on nested working
Different type (like date) fixed and bug
...
Copyright 2016 Simon Gendrin and other contributors
